...
\section{Tests de hipótesis}
    ...
    \begin{definition}
        Consideremos una muestra aleatoria simple $X_1, \dots, X_n$ de $X$. Un test de hipótesis es una regla que permite dividir el espacio muestral en dos subconjuntos medibles disjuntos. Estos conjuntos se corresponden con aquellas muestras que aceptan la hipótesis nula como cierta (región de aceptación) y aquellas muestras que rechazan la hipótesis nula y aceptan la hipótesis alternativa (región crítica).
    \end{definition}
