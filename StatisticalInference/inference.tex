...
\begin{definition}
	...
	Dada una muestra aleatoria simple $X_1,\dots,X_n$ de $X$, y un vector de observaciones de la muestra $\utilde{x}=(x_1,\dots,x_n)$, se define la distribución a posteriori de $\theta$ como la ley condicional de $\theta$ dadas las observaciones $\utilde{x}$ de $\utilde{X}$. Su función de densidad se puede escribir en función de la distribución a priori y $f(\utilde{x}|\theta)$ mediante el Teorema de Bayes, obteniendo
