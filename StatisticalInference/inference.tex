...
\begin{definition}
	...
	Dada una muestra aleatoria simple $\utilde{X} = (X_1,\dots,X_n)$ de $X$, y una realización de la muestra $\utilde{x}=(x_1,\dots,x_n)$, se define la distribución a posteriori de $\theta$ como la ley de $\theta$ condicional a la realización $\utilde{x}$ de $\utilde{X}$. Su función de densidad se puede escribir en función de la distribución a priori y $f(\utilde{x}|\theta)$ mediante el Teorema de Bayes, obteniendo
