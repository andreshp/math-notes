...
\begin{proposition} \label{prop:encerrar} Consieremos una EDO de la forma $x' = f(x)$, donde $f$
  ...
  $f$ se anula en $\mathrm{Fr}(\Omega)$. Sea $\varphi \colon ]\alpha, \omega[ \to \R^d$ solución
  maximal del PVI asociado a $(t_0, x_0)$. Si $x_0 \in \Omega$, entonces $\varphi(t) \in \Omega$
  para todo $t \in ]\alpha, \omega[$.
\end{proposition}
\begin{proof}
  Tenemos que $\varphi(t) \not\in \mathrm{Fr}(\Omega)$ para todo $t \in ]\alpha, \omega[$. En
  efecto, si $\varphi(t_1) \in \mathrm{Fr}(\Omega)$, entonces $\varphi$ es solución del PVI cuya
