...
\begin{proof}
  ...
  \[\Psi(t) = \begin{cases} \varphi(t) & \text{si } t \le \omega; \widetilde{\varphi}(t) & \text{si } t > \omega;\\\end{cases}\]
  es una solución de \eqref{eq:pvi} y, por tanto, es una prolongación de $\varphi$.
\end{proof}
