...
En esta sección intentamos generalizar el Corolario \ref{cor:dominio}. Como motivación considerese
...
\begin{definition}
  Sea $\varphi \colon ]\alpha, \omega[ \to \R^d$ una solución maximal de \eqref{eq:pvi}. Diremos que la
